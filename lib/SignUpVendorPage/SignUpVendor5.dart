...
class SignUpVendor5 extends StatefulWidget {
  SignUpVendor5({Key? key}) : super(key: key);

  @override
  _SignUpVendor5State createState() => _SignUpVendor5State();
}

class _SignUpVendor5State extends State<SignUpVendor5> {
