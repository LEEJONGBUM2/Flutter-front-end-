...
class SignUpVendor2 extends StatefulWidget {
  SignUpVendor2({Key? key}) : super(key: key);

  @override
  _SignUpVendor2State createState() => _SignUpVendor2State();
}

class _SignUpVendor2State extends State<SignUpVendor2> {
