...
import 'package:iconnexz/SignUpVendorPage/SignUpVendorPage6.dart';
    ...
    return Sizer(builder: (context, orientation, deviceType) {
      return MaterialApp(
        ...
        routes: {
          ...
          '/SignupVendor1': (context) => SignUpVendorPage1(),
          '/SignupVendor2': (context) => SignUpVendorPage2(),
          '/SignupVendor3': (context) => SignUpVendorPage3(),
          '/SignupVendor4': (context) => SignUpVendorPage4(),
          '/SignupVendor4a': (context) => SignUpVendorPage4a(),
          '/SignupVendor5': (context) => SignUpVendorPage5(),
          '/SignupVendor6': (context) => SignUpVendorPage6(),
