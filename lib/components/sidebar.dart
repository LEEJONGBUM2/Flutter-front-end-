...
class _MyHomePageState extends State<Sidenav> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        itemCount: _sidebar == null ? 0 : (_sidebar.length > 1 ? 1 : _sidebar.length),
        itemBuilder: (context, index) {
          return SingleChildScrollView(
            ...
            children: [
                  ...
                  child: DrawerHeader(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(_image[0].imageFilePath.toString()),
                        fit: BoxFit.contain,
                      ),
                    ),
                    child: null,
              ...
              _navItem(context, "assets/icons/menu_dashbord.svg", _sidebar[0].item1.toString(),
                  onTap: () {
                _navItemClicked(context, 0);
                Navigator.pushNamed(context, '/Dashboard');
              }, selected: selectedIndex == 0),
              _navItem(context, 'assets/icons/menu_profile.svg', _sidebar[0].item2.toString(),
                  onTap: () {
                _navItemClicked(context, 1);
                Navigator.pushNamed(context, '/VendorAccountEdit');
              }, selected: selectedIndex == 1),
              _navItem(context, 'assets/icons/menu_doc.svg', _sidebar[0].item3.toString(),
                  onTap: () {
              ...
              ExpansionTile(
                ...
                children: <Widget>[
                  _navItem(context, 'assets/icons/Documents.svg', _sidebar[0].item5.toString(),
                      onTap: () {
              ...
              _navItem(context, 'assets/icons/menu_store.svg', _sidebar[0].item6.toString(),
                  onTap: () {
                _navItemClicked(context, 5);
                Navigator.pushNamed(context, '/Wallet');
              }, selected: selectedIndex == 5),
              _navItem(context, 'assets/icons/tag.svg', _sidebar[0].item7.toString(), onTap: () {
                _navItemClicked(context, 6);
                Navigator.pushNamed(context, '/Voucher');
              }, selected: selectedIndex == 6),
                _navItem(context, 'assets/icons/folder.svg', _sidebar[0].item8.toString(),
                      onTap: () {
