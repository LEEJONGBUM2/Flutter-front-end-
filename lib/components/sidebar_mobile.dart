    ...
    return Drawer(
      child: ListView.builder(
        ...
        children: [
          ...
          _navItem(context, 'assets/icons/menu_dashbord.svg', onTap: () {
            _navItemClicked(context, 0);
            Navigator.pushNamed(context, '/Dashboard');
          }, selected: selectedIndex == 0),
          _navItem(context, 'assets/icons/menu_profile.svg', onTap: () {
          ...
          ExpansionTile(
            ...
            children: <Widget>[
              _navItem(context, 'assets/icons/Documents.svg', onTap: () {
                _navItemClicked(context, 3);
                Navigator.pushNamed(context, '/Orders');
              }, selected: selectedIndex == 3),
              _navItem(context, 'assets/icons/drop_box.svg', onTap: () {
